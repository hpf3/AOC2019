...
{
    internal class Solution4P2CB:structs.SolutionBase
    {
        public override string Name => "Day 4 Part 2 CB";
        ...
        public override string Solve(string input)
        {
            ...
            foreach (var group in input.Split("\n"))
            {
                ...
                if (!((zones[0, 0] < zones[1, 0] && zones[0, 1] < zones[1, 0]) || (zones[0, 0] > zones[1, 1] && zones[0, 1] > zones[1, 1])))
                {
                    count++;
                }
            }
